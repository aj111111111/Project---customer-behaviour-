Here is a concise summary of the project work completed:

**Data Cleaning & Export:** Cleaned the raw retail dataset by handling missing values, standardizing data types, and exporting the final version to csv file.
...
**Data Analysis using SQL:** QNA - 10 Question related to **business & solutions** thorough analysis done using SQL.
